...
**[一个基于 Vue 3 + Vite + Vanilla CSS 构建的 留学与保研申请 微应用，具备深色玻璃拟态自适应交互与微信端 H5 体验]**

[Vue 3] · [TypeScript] · [Vite] · [Vanilla CSS] · [开源协议 MIT]

[![GitHub stars](https://img.shields.io/github/stars/WT-Agent/ai-liuxue?style=social)](https://github.com/WT-Agent/ai-liuxue)
[![GitHub license](https://img.shields.io/github/license/WT-Agent/ai-liuxue)](https://github.com/WT-Agent/ai-liuxue/blob/main/LICENSE)
...
### 1. 克隆项目
```bash
git clone https://github.com/WT-Agent/ai-liuxue.git
cd ai-liuxue
```
...
- GitHub Issues: [提交反馈](https://github.com/WT-Agent/ai-liuxue/issues)
- 邮箱: us@wuxian.xyz
